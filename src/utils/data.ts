...
export const data = [
  {
    ...
    pathology_types: [
        ...
        agents: [
          {
            ...
            path: '19 TER.pdf',
            n_table: '1.1.19 ter',            ID: 10119.8,
          },
          {
            name: 'Charbon',
            path: 'CHARBON.pdf',
            n_table: '1.1.15',            ID: 10115,
          },
          {
            name: 'Mines de fer',
            path: 'MINES FER.pdf',
            n_table: '1.1.17 bis',            ID: 10117.4,
          },
          {
            name: "Poussières d'amiante",
            path: '1113.pdf',
            n_table: '1.1.13',            ID: 10113,
          },
          {
            name: 'Poussières de cobalt associées au carbure de tungstène avant frittage. ',
            path: '114TER.pdf',
            n_table: '1.1.4 ter',            ID: 10104.8,
          },
              {
                name: "Silice cristalline, silicates cristallins, graphite ou houille",
                path: '1112.pdf',
                n_table: '1.1.12',            ID: 10112,
              },
        ...
        agents: [
          {
            ...
            path: '1121.pdf',
            n_table: '1.1.21',            ID: 10121,
          },
          {
            name: 'Béryllium et à ses composés ',
            path: '115.pdf',
            n_table: '1.1.5',            ID: 10105,
          },
          {
            name: "Pneumopathies d'hypersensibilité ",
            path: '182.pdf',
            n_table: '1.8.2',            ID: 10802,
          },
          {
            name: 'Poussières de carbures métalliques frittés ou fondus contenant du cobalt. ',
            path: '114BIS.pdf',
            n_table: '1.1.4 bis',            ID: 10104.4,
          },
          {
            name: 'Sélénium et ses dérivés minéraux',
            path: '120.pdf',
            n_table: '1.1.20',            ID: 10120,
          },
          {
            name: 'Spirochétoses ',
            path: '34.pdf',
            n_table: '3.4',            ID: 30400,
          },
          {
            name: 'Tularémie ',
            path: '316.pdf',
            n_table: '3.16',            ID: 31600,
          },
        ],
      },
      {
        ...
        agents: [
          {
            ...
            path: '1218.pdf',
            n_table: '1.2.18',            ID: 10218,
          },
          {
            name: 'Grillage des mattes de nickel',
            path: 'matte_20.pdf',
            n_table: '1.1.8 ter',            ID: 10108.8,
          },
        ],
      },
      {
      ...
      },
      {
        ...
        agents: [
          ...
          },
          {
            name: 'Fer',
            path: 'fer.pdf',
            n_table: '1.1.16',            ID: 10116,
          },
          {
            name: 'Poussières textiles végétales ',
            path: '161.pdf',
            n_table: '1.6.1',            ID: 10601,
          },
        ],
      },
      {
      ...
      },
      {
        ...
        agents: [
          {
            name: "Huiles et graisses d'origine minérale ou de synthèse ",
            path: '125;.pdf',
            n_table: '1.2.5',            ID: 10205,
          },
        ],
      },
      {
      ...
      },
      {
        ...
        name: 'Tuberculose ou autre mycobactériose (complication)',
        agents: [
          {
            name: "Silice cristalline, silicates cristallins, graphite ou houille",
            path: '1112.pdf',
        ...
        name: 'Surinfection ou suppuration bactérienne broncho-pulmonaire subaiguë ou chronique (complication)',
        agents: [
          {
            name: "Silice cristalline, silicates cristallins, graphite ou houille",
            path: '1112.pdf',
    ...
    pathology_types: [
      ...
      },
      {
        ...
        agents: [
          ...
          {
            name: 'Chlorpromazine (Largactyl)',
            path: '153.pdf',
            n_table: '1.5.3',            ID: 10503,
          },
          {
            name: 'Ciments ( Amino-silicates de calcium)',
            path: 'ciment.pdf',
            n_table: '1.1.11',            ID: 10111,
          },
          {
            name: "Dérivés nitrés du phénol (dinitrophénols,dinitro-orthocrésol, dinoseb), par le pentachlorophénol, les pentachlorophénates et par les dérivés halogènes de l'hydroxybenzonitrile (bromoxynil, ioxynil) ",
            path: '126.pdf',
      ...
      {
        name: 'Otite moyenne subaiguë ou chronique',
        agents: [
          {
            name: "Agents infectieux ou parasitaires contractées en milieu d'hospitalisation et d'hospitalisation à domicile (staphylocoques, pseudomonas aeroginosa, enterocoque, méningocoque, strepto béta-hémolytique, fièvre typhoϊde A et B, choléra, fièvre hémorragique, herpes, syphilis, gale, gonocoque)",
            path: '310.pdf',
          ...
          },
          {
            ...
            path: '212.pdf',
            n_table: '2.12',            ID: 21200,
          },
          {
            name: 'Pression est supérieure à la pression atmosphérique ',
            path: '211.pdf',
            n_table: '2.11',            ID: 21100,
          },
        ],
      },
      {
        name: 'Blépharo-conjonctivite',
        agents: [
          {
            name: 'Arsenic et ses composés minéraux',
            path: '116.pdf',
          ...
          {
            name: 'Particules en circulation dans les puits de mine de charbon ',
            path: '23.pdf',
            n_table: '2.3',            ID: 20300,
          },
        ],
      },
      {
      ...
      {
        name: 'Blépharo-conjonctivite récidivante',
        agents: [
          {
            name: 'Isocyanates organiques ',
            path: '132.pdf',
      ...
      {
        name: 'Conjonctivite oedémateuse',
        agents: [
          {
            name: 'Kératoconjonctivites virales ',
            path: '36.pdf',
            n_table: '3.6',            ID: 30600,
          },
        ],
      },
      {
        name: 'Kératite nummulaire sous épithéliale',
        agents: [
          {
            name: 'Kératoconjonctivites virales ',
            path: '36.pdf',
      ...
      {
        name: 'Conjonctivite hémorragique',
        agents: [
          {
            name: 'Kératoconjonctivites virales ',
            path: '36.pdf',
      ...
      {
        name: 'Kératite superficielle ulcéreuse',
        agents: [
          {
            name: 'Kératoconjonctivites virales ',
            path: '36.pdf',
      ...
      {
        name: 'Nécrose du maxillaire inférieur',
        agents: [
          {
            name: 'Phosphore et sesquisulfure de phosphore',
            path: 'phspho.pdf',
            n_table: '1.1.9',            ID: 10109,
          },
        ],
      },
      {
        name: 'Lésion oreille interne',
        agents: [
          {
            name: 'Pression est inférieure à la pression atmosphérique et soumise à variations ',
            path: '212.pdf',
  ...
  {
    pathology_name: 'Pathologies cutanéo-muqueuses',
    pathology_types: [
      {
        ...
        agents: [
          ...
          {
            name: 'Aminoglycosides, notamment la streptomycine, par la néomycine et ses sels ',
            path: '151.pdf',
            n_table: '1.5.1',            ID: 10501,
          },
          {
            name: 'Aminoglycosides, notamment la streptomycine, par la néomycine et ses sels ',
            path: '151.pdf',
          ...
          {
            name: 'Résines époxydiques et leurs constituants ',
            path: '131.pdf',
            n_table: '1.3.1',            ID: 10301,
          },
        ],
      },
      {
      ...
      },
      {
        ...
        agents: [
          ...
          },
          {
            name: 'Rickettsies ',
            path: '313.pdf',
            n_table: '3.13',            ID: 31300,
          },
          {
            name: 'Tétrachlorure de carbone ',
            path: '1214.pdf',
            n_table: '1.2.14',            ID: 10214,
          },
          {
            name: 'virus des Hépatites A,B,C,D et E ',
            path: '311.pdf',
      ...
      },
      {
        ...
        agents: [
          {
            name: 'Amines aliphatiques, alicycliques ou les éthanolamines ',
            path: '1211.pdf',
            n_table: '1.2.11',            ID: 10211,
          },
          {
            name: 'Ciments ( Amino-silicates de calcium)',
            path: 'ciment.pdf',
          ...
          {
            name: 'oxydes et sels de nickel',
            path: 'oxydes sel nickel.pdf',
            n_table: '1.1.8',            ID: 10108,
          },
        ],
      },
      {
      ...
      },
      {
        ...
        agents: [
          {
            name: "Dérivés du pétrole : Huiles minérales peu ou non raffinées, huilles minérales régénérées utilisées dans les opérations d'usinage et de traitement des métaux, extraits aromatiques, résidus de craquage, huiles moteur usagées, suies de combustion des produits pétroliers ",
            path: '125.pdf',
            n_table: '1.2.5 bis',            ID: 10205.4,
          },
        ],
      },
      {
        ...
        agents: [
          {
            name: 'Dé́rivés halogénés des hydrocarbures aromatiques (monochlorobenzène, monobromobenzène, hexachlorobenzène)',
            path: '123.pdf',
            n_table: '1.2.3',            ID: 10203,
          },
        ],
      },
      {
      ...
      {
        name: 'Dermites chroniques ou récidivantes',
        agents: [
          {
            name: 'Tétrachloréthane',
            path: '1213.pdf',
            n_table: '1.2.13',            ID: 10213,
          },
        ],
      },
      {
  ...
  {
    pathology_name: 'Pathologies rénales, vésicales et génitales',
    pathology_types: [
      {
        ...
        agents: [
          {
            ...
            path: '121.pdf',
            n_table: '1.2.1',            ID: 10201,
          },
        ],
      },
      {
        name: 'Néphrite azotémique',
        agents: [
          {
            name: 'Mercure et ses composés',
            path: 'MERCURE.pdf',
  ...
  {
    pathology_name: 'Pathologies hématologiques',
    pathology_types: [
      {
        name: 'Syndrome hémorragique',
        agents: [
  ...
  {
    pathology_name: 'Pathologies hépatho-gastro-intestinales',
    pathology_types: [
      {
      ...
      },
      {
        ...
        agents: [
          ...
          {
            name: 'Benzène , toluène, xylènes et tous les produits les renfermant',
            path: '122BIS.pdf',
            n_table: '1.2.2 BIS',            ID: 10202.4,
          },
          {
            name: 'Cadmium et ses composés',
            path: 'CADMIUM.pdf',
...
export const getPathologiesByAgent = agentName => {
  const relatedPathologies = new Set();

  for (const pathology of data) {
    for (const pathologyType of pathology.pathology_types) {
      for (const agent of pathologyType.agents) {
        if (agent.name === agentName) {
          relatedPathologies.add(pathology.pathology_name);
          break;
        }
      }
    }
  ...
  return Array.from(relatedPathologies);
};
export const getAgentsByNtable = NTable => {
  const agents = [];

  for (const pathology of data) {
    for (const pathologyType of pathology.pathology_types) {
      for (const agent of pathologyType.agents) {
        if (agent.n_table === NTable) {
...
export const getAllNtableau = () => {
  const agents = [];

  for (const pathology of data) {
    for (const pathologyType of pathology.pathology_types) {
      for (const agent of pathologyType.agents) {
        const existingAgent = agents.find(a => a.n_table === agent.n_table)
        if (!existingAgent) {
          agents.push(agent);
        }
...
export const searchAgents = searchTerm => {
  return getAllAgents().filter(agent => {
    const regex = new RegExp(searchTerm, 'gi');
    return agent.name.match(regex) || agent.n_table.match(regex);
  });
};
export const searchAgents2 = searchTerm => {
  return getAllNtableau().filter(agent => {
    const regex = new RegExp(searchTerm, 'gi');
    return agent.name.match(regex) || agent.n_table.match(regex);
  });
};