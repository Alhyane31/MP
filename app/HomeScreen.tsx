      ...
      <View style={styles.container}>
        <View style={styles.card}>
          ...
          <TouchableOpacity
            ...
            onPress={() => router.push({ pathname: '/AgentsScreen', params: { pathology: selectedPathology, pathologyType: selectedPathologyType } })}
...
const styles = StyleSheet.create({
  ...
  modalContent: { backgroundColor: 'white', padding: 20, borderRadius: 10, width: '100%', maxHeight: '100%' },
